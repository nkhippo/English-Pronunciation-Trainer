...
`docs/reference/i18n-audit.md` と `docs/reference/gloss-flags.md` は `python3 tools/gen_audit_docs.py` で再生成する。
...
| `docs/reference/i18n-audit.md` | キー×言語スナップショット（`gen_audit_docs.py` で再生成） |
| `docs/reference/gloss-flags.md` | gloss 機械フラグ一覧（同上） |
| `docs/reference/i18n-language-scaling.md` | 本ドキュメント（運用プレイブック） |
